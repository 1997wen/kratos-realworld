...
const OperationRealWorldAddArticle = "/realworld.v1.RealWorld/AddArticle"
...
func RegisterRealWorldHTTPServer(s *http.Server, srv RealWorldHTTPServer) {
	...
	r.POST("/api/articles/{slug}/comments", _RealWorld_AddArticle0_HTTP_Handler(srv))
...
func _RealWorld_AddArticle0_HTTP_Handler(srv RealWorldHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		http.SetOperation(ctx, OperationRealWorldAddArticle)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.AddArticle(ctx, req.(*AddArticleRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
...
type RealWorldHTTPClient interface {
	AddArticle(ctx context.Context, req *AddArticleRequest, opts ...http.CallOption) (rsp *SingleCommentReply, err error)
	CreateArticle(ctx context.Context, req *CreateArticleRequest, opts ...http.CallOption) (rsp *SingleArticleReply, err error)
	DeleteArticle(ctx context.Context, req *DeleteArticleRequest, opts ...http.CallOption) (rsp *SingleCommentReply, err error)
...
func (c *RealWorldHTTPClientImpl) AddArticle(ctx context.Context, in *AddArticleRequest, opts ...http.CallOption) (*SingleCommentReply, error) {
	var out SingleCommentReply
	pattern := "/api/articles/{slug}/comments"
	path := binding.EncodeURL(pattern, in, false)
	opts = append(opts, http.Operation(OperationRealWorldAddArticle))
...
func (c *RealWorldHTTPClientImpl) DeleteArticle(ctx context.Context, in *DeleteArticleRequest, opts ...http.CallOption) (*SingleCommentReply, error) {
	var out SingleCommentReply

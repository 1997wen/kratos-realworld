...
func (s *RealWorldService) Login(ctx context.Context, req *v1.LoginRequest) (reply *v1.UserReply, err error) {
	return &v1.UserReply{
		User: &v1.UserReply_User{Username: "henry", Email: "1173@mapgoo.net"},
	}, nil
}

func (s RealWorldService) Registration(ctx context.Context, req *v1.RegistrationRequest) (reply *v1.UserReply, err error) {
	return &v1.UserReply{
		User: &v1.UserReply_User{Username: "henry", Email: "1173@mapgoo.net"},
	}, nil
}
...
func (s RealWorldService) DeleteArticle(ctx context.Context, req *v1.DeleteArticleRequest) (reply *v1.SingleCommentReply, err error) {
	return &v1.SingleCommentReply{}, nil
}

func (s RealWorldService) AddArticle(ctx context.Context, req *v1.AddArticleRequest) (reply *v1.SingleCommentReply, err error) {
	return &v1.SingleCommentReply{}, nil
}
